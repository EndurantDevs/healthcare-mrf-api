...
"""Restore hospital price version count and hash invariants.

Revision ID: 20260902103500_hospital_price_count_invariants
Revises: 20260901103000_plan_pricing_em_distance
"""
...
revision = "20260902103500_hospital_price_count_invariants"
down_revision = "20260901103000_plan_pricing_em_distance"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    """Keep every parser branch inside the shared hash and count guards."""
...
def downgrade() -> None:
    """Do not restore the weakened constraint."""
