...
"""Admit source-declared short CMS V2 hospital CSV versions.

Revision ID: 20260901000000_hospital_price_csv_short_v2
Revises: 20260831180000_hospital_price_csv_transition_metadata
"""
...
revision = "20260901000000_hospital_price_csv_short_v2"
down_revision = "20260831180000_hospital_price_csv_transition_metadata"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    """Admit exact version ``2`` only for V2 CSVs under parser v5."""
...
def downgrade() -> None:
    """Retain valid short-version rows rather than make them invalid."""
