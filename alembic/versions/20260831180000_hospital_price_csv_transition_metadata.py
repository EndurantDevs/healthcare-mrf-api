...
"""Retain optional forward metadata from declared V2 hospital CSV files.

Revision ID: 20260831180000_hospital_price_csv_transition_metadata
Revises: 20260831100000_hospital_price_legacy_header
"""
...
revision = "20260831180000_hospital_price_csv_transition_metadata"
down_revision = "20260831100000_hospital_price_legacy_header"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    """Admit only source-declared V2 CSV forward metadata under parser v4."""
...
def downgrade() -> None:
    """Retain valid forward metadata rather than make existing rows invalid."""
