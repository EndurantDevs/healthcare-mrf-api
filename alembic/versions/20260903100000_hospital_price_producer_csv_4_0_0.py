...
"""Admit producer-declared CSV 4.0.0 under the strict V3 shape.

Revision ID: 20260903100000_hospital_price_producer_csv_4_0_0
Revises: 20260902160000_hospital_price_rate_term
"""
...
revision = "20260903100000_hospital_price_producer_csv_4_0_0"
down_revision = "20260902160000_hospital_price_rate_term"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    """Admit exact CSV 4.0.0 only for the current parser contract."""
    ...
    op.execute(
        ...
        "AND template_version = '4.0.0' AND npi_count > 0 "
