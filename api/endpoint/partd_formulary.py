        ...
        await session.execute(
            text(
                ...
                SELECT
                    ...
                    a.pharmacy_type,
                    a.mail_order,
                    a.dispensing_fee_brand_30,
                    a.dispensing_fee_brand_60,
                    a.dispensing_fee_brand_90,
                    a.dispensing_fee_generic_30,
                    a.dispensing_fee_generic_60,
                    a.dispensing_fee_generic_90,
                    a.dispensing_fee_selected_drug_30,
                    a.dispensing_fee_selected_drug_60,
                    a.dispensing_fee_selected_drug_90,
                    a.effective_from,
                    a.effective_to,
                    a.source_type
        ...
        items.append(
            {
                ...
                "dispensing_fee_brand_30": mapping.get("dispensing_fee_brand_30"),
                "dispensing_fee_brand_60": mapping.get("dispensing_fee_brand_60"),
                "dispensing_fee_brand_90": mapping.get("dispensing_fee_brand_90"),
                "dispensing_fee_generic_30": mapping.get("dispensing_fee_generic_30"),
                "dispensing_fee_generic_60": mapping.get("dispensing_fee_generic_60"),
                "dispensing_fee_generic_90": mapping.get("dispensing_fee_generic_90"),
                "dispensing_fee_selected_drug_30": mapping.get("dispensing_fee_selected_drug_30"),
                "dispensing_fee_selected_drug_60": mapping.get("dispensing_fee_selected_drug_60"),
                "dispensing_fee_selected_drug_90": mapping.get("dispensing_fee_selected_drug_90"),
