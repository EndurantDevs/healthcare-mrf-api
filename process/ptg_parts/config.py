...
PTG2_RUST_RAPIDGZIP_THREADS_ENV = "HLTHPRT_PTG2_RUST_RAPIDGZIP_THREADS"
...
PTG2_V3_FINALIZER_WORKERS_ENV = "HLTHPRT_PTG2_V3_FINALIZER_WORKERS"
PTG2_V3_FINALIZER_IDENTITY_MAP_MAX_BYTES_ENV = (
    "HLTHPRT_PTG2_V3_FINALIZER_IDENTITY_MAP_MAX_BYTES"
)
PTG2_V3_FINALIZER_TOTAL_SORT_MEMORY_BYTES_ENV = (
    "HLTHPRT_PTG2_V3_FINALIZER_TOTAL_SORT_MEMORY_BYTES"
)
PTG2_V3_FINALIZER_LEGACY_MEMORY_RECORDS_ENV = (
    "HLTHPRT_PTG2_V3_FINALIZER_MEMORY_RECORDS"
)
...
PTG2_V3_FINALIZER_MAX_WORKERS = 64
PTG2_V3_FINALIZER_MIN_IDENTITY_MAP_MAX_BYTES = 64 * 1024 * 1024
PTG2_V3_FINALIZER_MAX_IDENTITY_MAP_MAX_BYTES = 512 * 1024 * 1024 * 1024
PTG2_V3_FINALIZER_MIN_SORT_MEMORY_BYTES_PER_WORKER = 16 * 1024 * 1024
PTG2_V3_FINALIZER_MAX_TOTAL_SORT_MEMORY_BYTES = 256 * 1024 * 1024 * 1024
PTG2_V3_FINALIZER_MIN_UNBUDGETED_MEMORY_BYTES = 1024 * 1024 * 1024
PTG2_V3_FINALIZER_CONFIGURED_MEMORY_NUMERATOR = 3
PTG2_V3_FINALIZER_CONFIGURED_MEMORY_DENOMINATOR = 4
