...
PROVIDER_QUALITY_KEEP_WORKDIR = _is_environment_enabled("HLTHPRT_PROVIDER_QUALITY_KEEP_WORKDIR", default=False)
PROVIDER_QUALITY_DOWNLOAD_CONCURRENCY = max(
    int(os.getenv("HLTHPRT_PROVIDER_QUALITY_DOWNLOAD_CONCURRENCY", "2")),
    1,
)
PROVIDER_QUALITY_DEFER_STAGE_INDEXES = _is_environment_enabled(
...
PROVIDER_QUALITY_COHORT_ENABLED = _is_environment_enabled("HLTHPRT_PROVIDER_QUALITY_COHORT_ENABLED", default=True)
PROVIDER_QUALITY_MATERIALIZE_SHARDED_ENABLED = _is_environment_enabled(
...
PROVIDER_QUALITY_SHARD_JIT = "on" if _is_environment_enabled("HLTHPRT_PROVIDER_QUALITY_SHARD_JIT", default=False) else "off"
...
PROVIDER_QUALITY_FAIL_ON_SOURCE_ERROR = _is_environment_enabled("HLTHPRT_PROVIDER_QUALITY_FAIL_ON_SOURCE_ERROR", default=True)
PROVIDER_QUALITY_ALLOW_DEGRADED_TEST_ONLY = _is_environment_enabled("HLTHPRT_PROVIDER_QUALITY_ALLOW_DEGRADED_TEST_ONLY", default=True)
...
PROVIDER_QUALITY_GLOBAL_FINALIZE_LOCK_REFRESH_SECONDS = max(
    PROVIDER_QUALITY_GLOBAL_FINALIZE_LOCK_TTL_SECONDS // 3,
    1,
)
