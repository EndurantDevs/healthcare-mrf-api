...
| Washington (`washington`) | Acquisition-configured | None | REST | InsurancePlan, PractitionerRole, Practitioner, Organization, Location, HealthcareService, OrganizationAffiliation, Endpoint | https://wa.fhir.mhbapp.com/pd/api/v1 | pdfhir_ab222634556364c6b0815409 | Uses standard _count=100 pagination; Location pagination was revalidated after the earlier gateway limit was removed. |
| Wyoming (`wyoming`) | Acquisition-configured | None | REST | InsurancePlan, PractitionerRole, Practitioner, Organization, Location, HealthcareService, OrganizationAffiliation, Endpoint | https://wy.fhir.mhbapp.com/pd/api/v1 | pdfhir_72257bf04f7fb816c0ad6fb9 | Uses standard _count=100 pagination; PractitionerRole pagination was revalidated after the earlier gateway limit was removed. |
...
| UHC (`uhc`) | Acquisition-configured | None | REST | InsurancePlan, Location, Organization, OrganizationAffiliation, Practitioner, PractitionerRole | https://flex.optum.com/fhirpublic/R4 | pdfhir_0b5cfd565c53364a73981dcb | InsurancePlan is anonymously pageable one row at a time. Optum caps five core collections at 10,000 search results and does not expose a proven exhaustive residual query, so full acquisition currently fails closed; maximal graph discovery must remain distinct from verified-complete publication. HealthcareService and Endpoint are excluded. |
