...
| repo curated master list, payer/TPA public transparency pages, configured platform resolvers, CMS TiC schema references | decentralized payer Transparency in Coverage MRF source registry and schema references | `mrf-source-discovery` | searchable payer/source/plan/file URL catalog, including issuer and TPA-hosted sources, for PTG discovery and selected full PTG imports |
