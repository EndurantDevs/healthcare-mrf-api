...
| Capital Blue Cross | blue | https://capitalbluecross.healthsparq.com/app/public/#/one/insurerCode=CAPBC_I&brandCode=CAPBC/ | curated source row; aliases: NVA, National Vision Administrators, National Vision Administrator, Capital Blue Cross Vision NVA |
| Capital Blue Cross | blue | https://capitalbluecross.healthsparq.com/app/public/#/one/insurerCode=CAPBC_I&brandCode=CAPBC/machine-readable-transparency-in-coverage | observed current; 7,555 plans; 4,892 files; aliases: NVA, National Vision Administrators, National Vision Administrator, Capital Blue Cross Vision NVA |
...
| Davis Vision | network/tpa | - | needs official source URL; aliases: Davis Vision by MetLife, Versant Health Davis Vision, Davis Vision Guardian, Guardian - Davis Vision, Highmark Davis Vision |
| Superior Vision | network/tpa | - | needs official source URL; aliases: Superior Vision by MetLife, Versant Health Superior Vision, MetLife Superior Vision, Superior Vision - Met Life, SuperiorVision, Cypress Admin (Superior Vision Network) |
...
| EyeMed | vision | https://content.eyemedvisioncare.com/EyeMed_HCSC/eyemed_in-network-rates.json | public HCSC-linked EyeMed in-network MRF body; benefit lines: vision; aliases: EyeMed Vision Care, EyeMed Vision Benefits, EyeMed Vision Network, EyeMed Vision Care LLC, Eye Med, Aetna Vision, Aetna Vision Preferred, Aetna Vision Network, Ameritas Vision, Ameritas EyeMed, Ameritas EyeMed Vision, Ameritas Vision EyeMed, Ameritas with EyeMed, Mutual of Omaha EyeMed, Mutual of Omaha EyeMed Vision Care, Mutual of Omaha with EyeMed, Pacific Life EyeMed, Blue 20/20 of Massachusetts (powered by EyeMed), BlueCare Vision EyeMed, BlueCare Vision of Illinois (powered by EyeMed), BlueCare Vision of Texas, BlueCare Vision of Texas (powered by EyeMed), Cigna Vision serviced by EyeMed, Dearborn EyeMed, Dearborn National with EyeMed, Delta Vision, Delta Vision EyeMed, DeltaVision, DeltaVision EyeMed, DeltaVision administered by EyeMed, DeltaVision with EyeMed, Delta Dental EyeMed Vision, Unum Vision Powered by Eyemed, Surency, Surency Vision, Surency EyeMed, Companion Life EyeMed, Companion Life EyeMed Network, ProTec, Advantica |
...
| VSP Vision | network/tpa | https://bcbsm.sapphiremrfhub.com/tocs/current/vsp_vision | public VSP Vision machine-readable file linked from VSP careers transparency note; benefit lines: vision; aliases: VSP, Vision Service Plan, Vision Service Plan (VSP), Vision Plan Service, Vision Plan Service (VSP), Vision Serivce Plan (VSP), VSP Vision Care, VSP Choice, VSP Choice Network, VSP Choice Plan, Principal VSP, Principal Financial Group VSP, Principal Financial Group - VSP, Principal / VSP, Principal Vision VSP, MetLife VSP, MetLife VSP Choice, MetLife Vision with VSP Choice, MetLife using VSP Choice Network, Metlife / VSP, Sun Life VSP, SunLife VSP, SunLife/VSP, Sun Life Vision VSP, Guardian VSP, Guardian/VSP, Guardian/VSP Vision, Guardian VSP Network, Guardian - VSP Network, Guardian Vision, Guardian Vision Powered by VSP, VSP Guardian, VSP Service Plan, VPS Vision Care, Ameritas Vision, Ameritas VSP, Ameritas VSP Vision, Ameritas Vision VSP, Ameritas with VSP, VSP Ameritas, Equitable VSP, Equitable Vision VSP, Renaissance VSP, Renaissance Vision VSP, Beam VSP, Beam Vision VSP, Beam Benefits VSP, Companion Life VSP, Companion Life VSP Network, Delta Vision, DeltaVision, DeltaVision VSP, DeltaVision with VSP, Delta Dental VSP Vision, United Heritage (Using VSP Network) |
| Vision Benefits of America | vision | - | needs official source URL; aliases: VBA, VBA Plans, VBA Vision, Vision Benefits of Ameriva |
| Avesis | vision | - | needs official source URL; aliases: Avesis Vision, Avesis Third Party Administrators, Guardian Avesis |
