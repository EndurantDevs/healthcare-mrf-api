...
def test_checked_in_registry_has_exact_source_neutral_shape():
    ...
    assert len(registry.hospital_hpt_registry_groups()) == 6_894
    ...
    assert sum("fallback_mrf_url" in entry for entry in hospitals) == 158
...
@pytest.mark.parametrize("hospital_id,name,locator_url,location_names,ordinal", (
    ...
    ("hospital-006669", "UConn Health, Waterbury Hospital",
     "https://www.waterburyhospital.org/cms-hpt.txt",
     ("UConn Health, Waterbury Hospital",), 0),
