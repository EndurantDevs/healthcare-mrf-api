...
EXECUTION_V2_CANONICAL_SHA256 = (
    "5819256c6e18ef32b6a35684d2b0f48" "fb338c104c948e29030e9d186a101ed01"
)
EXECUTION_V2_FILE_SHA256 = (
    "db2ad550a5fd95c5dab76d4444be00ae" "4371ab58c3a84dc502a42c8ab6560e68"
)
...
def test_execution_v2_golden_freezes_neutral_cross_repository_envelope(
    ...
    assert len(fixture_bytes) == 27_831
