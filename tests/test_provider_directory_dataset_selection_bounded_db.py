...
from tests.provider_directory_dataset_selection_receipt_cases import (
    test_all_source_projection_normalizes_expected_source_scope,
    test_all_source_projection_rejects_resealed_semantic_proof_mutation,
    test_explicit_selection_does_not_evaluate_unrelated_metadata,
    test_final_publish_uses_sealed_summary_over_legacy_cap,
    test_payload_hash_documents_python_identity_boundary,
    test_payload_hash_fences_unknown_metadata_drift,
    test_sealed_canonical_proof_uses_bounded_receipt_over_legacy_cap,
)
