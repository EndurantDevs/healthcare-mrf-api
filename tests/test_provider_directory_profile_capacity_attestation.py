...
GOLDEN_ATTESTATION_ID = "ba212b6e0b5d896881d3dfc2d9784f1178714bd7d39a14d40cb0a4a78789c5a9"
GOLDEN_SIGNATURE = (
    "v6P19vskbJYiDzNIiqjR4wrqGQezMyvWvwQzdrBnktfrMO-RDQmUAarTvu1MS"
    "6C_oXJoZVPcTlXG72zm-EYABQ"
)
GOLDEN_CANONICAL_BODY_SHA256 = "28270550adfb684a76005af60cc832dd146d5aef81e3c830ff68ff37ead42e30"
...
def test_golden_vector_verifies_exact_canonical_schema_and_signature():
    ...
    assert verified.runtime_witness_sha256 == (
        "563c56bcd16a2db28ad1117e2f6772586dfae6fdc0a253aff5a62ed316ae8938"
    )
    ...
    assert verified.lease_digest == (
        "30c30890eb503490344432ff17a639c99dc8c8235b632ecef37a0137f56cd726"
    )
