...
def test_tall_notes_contract_changes_version_not_codec():
    ...
    assert HOSPITAL_MRF_PARSER_CONTRACT_SHA256 == ("bb8b427a158d00c4de9b7dca2cb97a25b5097b859404e4abe943483f47a1b184")
    content = "a" * 64
    old = hashlib.sha256(
...
def test_tall_notes_admission_only_appends_current_contract():
    ...
    migration = runpy.run_path(str(versions / "20260911100000_hospital_price_tall_notes.py"))
