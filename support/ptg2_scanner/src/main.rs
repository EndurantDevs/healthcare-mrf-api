...
use ptg2_scanner::hashing::{
    ...
    hash_text_key, make_checksum, price_set_entry_key, provider_entry_component_key,
    provider_group_member_key, provider_set_component_key, provider_set_entry_key, semantic_hash,
    shard_for_u128, shard_for_u64, update_hash_optional_str, update_hash_string_list,
};
